...
-- Original denormalized data (for reference)
...
-- --------------------------------------
-- SOLUTION FOR QUESTION 2: Transform to 2NF
-- --------------------------------------

-- For demonstration, create the OrderDetails table from Question 2
...
-- Insert data into the 2NF tables
